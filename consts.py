...
# LEDS
FX_SELECT_UPPER_BUTTON_ROW = 80
FX_SELECT_ENCODER_ROW = 81
FX_SELECT_LOWER_BUTTON_ROW = 82
FX_SELECT_POTIE_ROW = 83
FX_SELECT_DRUM_PAD_ROW = 84
fx_select_button_ccs = list(
    range(FX_SELECT_UPPER_BUTTON_ROW, FX_SELECT_DRUM_PAD_ROW + 1))
...
fx_ccs = fx_select_button_ccs + \
    fx_upper_button_row_ccs + fx_encoder_row_ccs + \
    fx_lower_button_row_ccs + fx_poti_row_ccs
fx_forwarded_ccs = fx_select_button_ccs + \
...
MX_SELECT_UPPER_BUTTON_ROW = 86
MX_SELECT_LOWER_BUTTON_ROW = 87
mx_select_button_ccs = list(
    range(MX_SELECT_SLIDER_ROW, MX_SELECT_LOWER_BUTTON_ROW + 1))

MX_SLIDER_ROW_BASE_CC = 16
mx_slider_row_ccs = __create_row_range(MX_SLIDER_ROW_BASE_CC)

MX_UPPER_BUTTON_ROW_BASE_CC = 40
mx_upper_button_row_ccs = __create_row_range(MX_UPPER_BUTTON_ROW_BASE_CC)

MX_LOWER_BUTTON_ROW_BASE_CC = 48
mx_lower_button_row_ccs = __create_row_range(MX_LOWER_BUTTON_ROW_BASE_CC)
...
mx_ccs = mx_select_button_ccs + \
    mx_upper_button_row_ccs + mx_lower_button_row_ccs + \
    mx_slider_row_ccs
mx_forwarded_ccs = mx_select_button_ccs + \
    mx_upper_button_row_ccs + mx_lower_button_row_ccs
mx_notes = []
mx_forwarded_notes = []
...
MX_DISPLAY = False
MX_UPPER_BUTTON_TYPE = 'SOLO'
MX_LOWER_BUTTON_TYPE = 'SELECT'
MX_DISPLAY_PAGE_DEVICE_CHILDS = True
MX_DISPLAY_PAGE_DEVICE_CHILDS_INVERT = False

FX_ENCODER_MORE_PARAMETERS = False
FX_ENCODER_ON_DEVICE_ACTIVE = True
FX_UPPER_BUTTON_ROW_SNAPSHOTS = True
FX_LOWER_BUTTON_ROW_DEVICE = True
FX_LOWER_BUTTON_ROW_DEVICE_ALL = False
FX_LOWER_BUTTON_ROW_DEVICE_CHILDS = True

if not MX_DISPLAY_PAGE_DEVICE_CHILDS:
    mx_ccs += mx_display_button_ccs
    mx_forwarded_ccs += mx_display_button_ccs

    fx_ccs += fx_display_button_ccs
    fx_forwarded_ccs += fx_display_button_ccs
else:
    if MX_DISPLAY_PAGE_DEVICE_CHILDS_INVERT:
        MX_DISPLAY_PAGE_UP = 88
        MX_DISPLAY_PAGE_DOWN = 89

        FX_DISPLAY_PAGE_UP = 90
        FX_DISPLAY_PAGE_DOWN = 91
    ...
    fx_ccs += mx_display_button_ccs
    fx_forwarded_ccs += mx_display_button_ccs

if not FX_UPPER_BUTTON_ROW_SNAPSHOTS:
    mx_ccs += ts_ccs
else:
    ts_ccs = [TS_LOCK]
    fx_ccs += ts_ccs
...
if FX_LOWER_BUTTON_ROW_DEVICE:
    fx_forwarded_ccs += fx_lower_button_row_ccs
